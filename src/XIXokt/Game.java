...
import static XIXokt.config.CharacterFactory.*;
import static XIXokt.config.MonsterFactory.*;
...
public class Game {
    ...
    public static Monster createRandomMonster() {
        ...
        switch (monsterType) {
            case 0:
                return createDefaultButcher(randomName);
            case 1:
                return createDefaultSkeletonKing(randomName);
            case 2:
                return createDefaultFallenShaman(randomName);
            default:
